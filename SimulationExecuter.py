...
def simulationExecuter(dir_simulations, dir_assignments,assignments, path_unity, path_TwinCat, test_names,dir_scratch):
    ...
    for i in range(len(assignments)):
        ...
        testExecuter(dir_simulations, fps, fourcc_avi, folder_dh_DT, assignments[i], path_unity, path_TwinCat, test_names,dir_scratch)
        as_end = time.time()
